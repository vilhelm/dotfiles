...
{ my $broken_expandos = (Irssi::version >= 20081128 && Irssi::version < 20110210)
  ...
  Irssi::theme_register([
    ...
    set 'display_nokey'		=>     '$N:$H$C$S',
    set 'display_key'		=>     '$Q:$H$C$S',
    set 'display_nokey_visible' =>     '$N:$H$C$S',
    set 'display_key_visible'	=>     '$Q:$H$C$S',
    set 'display_nokey_active'	=> '%7%Y$N:$H$C$S',
    set 'display_key_active'	=> '%7%Y$Q:$H$C$S',
    set 'display_header'	=> '',
    set 'name_display'		=> '$0',
    set 'separator'		=> ' ',
    set 'separator2'		=> '',
